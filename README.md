...
(VFM) has significantly boosted the segmentation performance. However, in real-world deployment, a pretrained VFM must handle remote sensing images from other domains that it has never encountered. In this
...
FIGURE 3:Framework overview of the proposed Joint Spectral-Spatial Adapter (SSA). Given a vision foundation model
...
Our code will be released after publication. Stay tuned!
